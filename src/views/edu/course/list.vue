<template>
  <div class="app-container">
    ...
    <!--查询表单-->
    <el-form :inline="true" v-model="CourseQueryVo" class="demo-form-inline">
      <el-form-item>
        <el-input v-model="CourseQueryVo.title" placeholder="课程名称"/>
      </el-form-item>

      <el-form-item>
        <el-select
          v-model="CourseQueryVo.status"
          clearable
          placeholder="课程状态"
        >
      ...
      <el-form-item>
        <el-input v-model="CourseQueryVo.teacherId" placeholder="教师id"/>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      this.page = page;
      course
        .getPageList(this.page, this.limit, this.CourseQueryVo)
        .then((response) => {
          //请求成功
          //response接口返回的数据
